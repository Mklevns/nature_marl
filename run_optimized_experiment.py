...
class OptimizedExperiment:
    ...
    def setup_optimized_environment(self):
        ...
        def create_env(env_config):
            ...
            pz_env = ParallelPettingZooEnv(env)
    ...
    def create_optimized_config(self):
        ...
        ppo_config = ppo_config.callbacks(PerformanceMonitoringCallbacks)
...
class PerformanceMonitoringCallbacks(RealEmergenceTrackingCallbacks):
